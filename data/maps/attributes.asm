...
ENDM
	...
	map_attributes VioletCity, VIOLET_CITY, $5, NORTH | SOUTH | EAST
	...
	map_attributes Route29, ROUTE_29, $5, WEST | EAST
	...
	map_attributes Route35, ROUTE_35, $5, SOUTH
	...
	map_attributes VioletOutskirts, VIOLET_OUTSKIRTS, $5, SOUTH
	...
	map_attributes GoldenrodHarbor, GOLDENROD_HARBOR, $35, WEST
	...
	map_attributes MovingTruck, MOVING_TRUCK, $0, 0
